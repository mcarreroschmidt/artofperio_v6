...
(function($) {
	...
	$.anythingSlider.defaults = {
		...
		forwardText         : "&gt;",    // Link text used to move the slider forward (hidden by CSS, replaced with arrow image) &raquo;
		backText            : "&lt;",    // Link text used to move the slider back (hidden by CSS, replace with arrow image) &laquo;
